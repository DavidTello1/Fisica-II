...
ModulePlayer1::ModulePlayer1(Application* app, bool start_enabled) : Module(app, start_enabled), vehicle(NULL)
{
...
vec3 ModulePlayer1::GetPos()
{
	return pos;
}

void ModulePlayer1::ReCalcPos(float move)
{
	pos.z += vehicle->GetKmh() / move;
}

// Update: draw background
update_status ModulePlayer1::Update(float dt)
{
	turn = acceleration = brake = 0.0f;
